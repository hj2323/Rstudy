##################################################
# Comparison with wine data( Classification)
##################################################
...
p.test.tree = predict(fit.prun.tree, newdata=wine.test, type="prob")[,2] #probablities
...
# Drawing ROCs
plot(perf.reg, lty=1, col=1, xlimc(0,1), ylim=c(0,1), xlab="1-Specificity", ylab="Sensitivity", main="ROC Curve")
